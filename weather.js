 ...
 let long;
 let lat;
 let tempratureDescreption=document.querySelector(".decription");
 ...
 if(navigator.geolocation){
    navigator.geolocation.getCurrentPosition(position=>{
        ...
        const api=`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=19848c425bd716176c481fb866914846&units=metric`;
        fetch(api).then(data=>{
            return data.json();
        }).then(data=>{
            timeZone.innerHTML=data.name;
            degree.innerHTML=data.main.temp;
            tempratureDescreption.innerHTML=data.weather[0].description.toUpperCase();
            const img=`<img src="http://openweathermap.org/img/wn/${data.weather[0].icon}@4x.png" alt="" class="icon">`;
            icons.innerHTML=img;
            console.log(data.weather[0].icon);
            if(data.weather[0].icon=="01d"){
                icons.innerHTML=`<div class="element">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 44.9 44.9" style="enable-background:new 0 0 44.9 44.9;" xml:space="preserve" height="65px" width="65px">
                  <g id="Sun">
                ...
                icons.innerHTML=`<div class="element">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30.8 42.5" style="enable-background:new 0 0 30.8 42.5;" xml:space="preserve" height="60px" width="60px">
                ...
                icons.innerHTML=` <div class="element">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 45.1 47.6" style="enable-background:new 0 0 45.1 47.6;" xml:space="preserve" height="65px" width="65px">
                  <style type="text/css">
                ...
                else if(data.weather[0].icon=="03n"||data.weather[0].icon=="03d"||data.weather[0].icon=="04d"||data.weather[0].icon=="04n")
                {
                    icons.innerHTML=` <div class="element">
